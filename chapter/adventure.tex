...
Each character begins with a set of skills, determined by their class (for PLAYER characters) or their statblock (CONDUCTOR characters). A PLAYER character can have a maximum of six different skills. Skills marked with an (S) are skills that, once acquired, require specification, e.g. the Art/Craft skill corresponds to how good a character is at doing one specific job; the Spell skill corresponds to how good a character is at casting a certain spell.
\begin{multicols}{2}
...
A skill that describes doing a job: e.g. blacksmithing; painting; fishing; etc.
...
\subsubsection*{Spell (S)}
The ability to perform a specific magic spell. Chapter \ref{sec:magic} explains the usage of this skill in detail.
...
The ability to fight with a weapon. When learning this skill, the character must specify which weapon they are good at.
